...
const $timeDisplay = document.querySelector('.time-remain')
...
const game = new Game($input, $words, $wpm, $timeDisplay, dividedWords)
$button.addEventListener('click', restart)//game.reset
